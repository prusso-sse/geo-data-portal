...
public class GDPFeatureParser {
    ...
    /**
     * This cleanup method removes the memory leak caused by not closing the
     * XMLStreamReader along w/ telling the handler to clean its objects up.
     */
    public void close() throws XMLStreamException {
    	pp.close();			// Close the XMLStreamReader
    	handler.cleanup();	// Have the handler clean up its created object arrays
    }
