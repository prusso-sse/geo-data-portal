...
/**
 * Sends commands to our running geoserver instance. User/Pass is mandatory
 *
 * @author isuftin
 */
...
public class GeoserverManagementAlgorithm extends AbstractAnnotatedAlgorithm {
    ...
    private static final Logger log = LoggerFactory.getLogger(GeoserverManagementAlgorithm.class);
    ...
    public void process() {
        ...
        try {
            ...
            log.error("Error: Unable to delete datastore", ex);
        }
    }
}
