...
var Dataset = function () {
	...
	/**
	 * Using a provided data object, populates the Dataset ID select control
	 * 
	 * @param {type} data
	 * @returns {undefined}
	 */
	 ...
	 * @returns {undefined}
	 */
	function initDatasetFilterButton() {
		var $selectBox = $(_DATASET_ID_SELECTBOX),
			$filterButton = $(_DATASET_FILTER_BUTTON_ID);
		
		var createDatasetFilterModal = function () {
			GDP.widget.DatasetFilter.create({
				selectControlSelector: _DATASET_ID_SELECTBOX
			});
		};
