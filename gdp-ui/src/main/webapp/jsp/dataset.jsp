...
<div id="dataset">
	...
	<div class="step-content hidden centered">
		...
		<div id="csw-client-div"  class="hidden">
			<table id="dataset-table">
				...
				<tr id="dataset-id-row">
					...
					<td>
						<span id="dataset-id-label" class="hidden">
							Select Datatype:<br />
							<input type="button" class="hidden" id="dataset-id-filter" value="Filter"/>
						</span>
					</td>
					<td>
		...
		<div id="dataset-filter-modal-wrap" class="hidden">
			<div id="dataset-filter-modal">
				<div id="dataset-filter-explanation">
					This tool allows selection of variables based on categories in the variable names. 
					If list of variables is long and the variable names have delimiters like - or _ this tool will 
					help select variables based on those categories.
				</div>
				<div id="dataset-filter-delim-selector">
					<form id="dataset-filter-delim-selector-form">
						Select a delimiter: 
						<input type="radio" name="delimiter" value="-">-
						<input type="radio" name="delimiter" value="_">_
					</form>
				</div>
				<div id="dataset-filter-select-count"></div>
				<div id="dataset-filter-listing"></div>
			</div>
		</div>
